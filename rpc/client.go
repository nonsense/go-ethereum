...
const (
	...
	defaultDialTimeout   = 20 * time.Second // used when dialing if the context has no deadline
	defaultWriteTimeout  = 20 * time.Second // used for calls if the context has no deadline
...
const (
	...
	// dropped.
	maxClientSubscriptionBuffer = 800000
)
